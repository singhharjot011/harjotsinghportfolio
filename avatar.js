...
function loadModel() {
  ...
  loader.load(
    "./public/AvatarWithLaptop.glb",
    (gltf) => {
      setupScene(gltf);
      document.getElementById("profile-pic-loading").style.display = "none";
    },
    (xhr) => {
...
function setupScene(gltf) {
  ...
  const typingClip = THREE.AnimationClip.findByName(clips, "AvatarTyping");
